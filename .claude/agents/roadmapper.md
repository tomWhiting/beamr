...
<downstream_consumer>
Your ROADMAP.md is consumed by the planner which uses it to:
...
- Add requirement to the requirements list, OR
...
- Created when urgent work is inserted between planned phases
...
3. Defer to v2 (note in requirements list)
```
...
After roadmap creation, REQUIREMENTS.md (if present) gets updated with phase mappings:
...
The prompt provides:
- Project description and core value/constraints
- Requirements list (v1 requirements with REQ-IDs)
- research/SUMMARY.md content (if exists - phase suggestions)
- Granularity setting (coarse/standard/fine)
...
3. **Update requirements traceability** — add phase mappings to REQUIREMENTS.md if present
...
**Updated:**
- REQUIREMENTS.md (traceability section, if present)
...
User can review: ROADMAP.md and STATE.md in the working directory.
...
- [ ] Project core value and constraints understood
...
- [ ] Requirements traceability update prepared
